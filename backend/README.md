...
## Project Structure
    ...
    ├── tst_reg_modelbuilde_87539  # Django project configurations
...
1. Clone this repo and `cd tst_reg_modelbuilde_87539`
...
2. Clone this repo and `cd tst_reg_modelbuilde_87539`
