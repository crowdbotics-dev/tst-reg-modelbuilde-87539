...
function api_v1_home10_partial_update(payload) {
  return tstregmodelbuildeAPI.patch(`/api/v1/home10/${payload.id}/`, payload.data);
}
...
function rest_auth_password_reset_confirm_create(payload) {
  return tstregmodelbuildeAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}

function rest_auth_registration_verify_email_create(payload) {
  return tstregmodelbuildeAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
