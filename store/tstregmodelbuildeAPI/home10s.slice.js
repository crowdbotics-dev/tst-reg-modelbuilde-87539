...
export const api_v1_home10_list = createAsyncThunk(
  "home10s/api_v1_home10_list",
  async payload => {
    const response = await apiService.api_v1_home10_list(payload)
    return response.data
  }
)
export const api_v1_home10_create = createAsyncThunk(
  "home10s/api_v1_home10_create",
  async payload => {
    const response = await apiService.api_v1_home10_create(payload)
    return response.data
  }
)
export const api_v1_home10_retrieve = createAsyncThunk(
  "home10s/api_v1_home10_retrieve",
  async payload => {
    const response = await apiService.api_v1_home10_retrieve(payload)
    return response.data
  }
)
export const api_v1_home10_update = createAsyncThunk(
  "home10s/api_v1_home10_update",
  async payload => {
    const response = await apiService.api_v1_home10_update(payload)
    return response.data
  }
)
export const api_v1_home10_partial_update = createAsyncThunk(
  "home10s/api_v1_home10_partial_update",
  async payload => {
    const response = await apiService.api_v1_home10_partial_update(payload)
    return response.data
  }
)
export const api_v1_home10_destroy = createAsyncThunk(
  "home10s/api_v1_home10_destroy",
  async payload => {
